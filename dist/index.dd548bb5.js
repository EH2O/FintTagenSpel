...
})({"dhiId":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "9582fc8bdd548bb5";
"use strict";
...
function movePlayer(player) {
    onKeyDown("a", ()=>{
        if (player.pos.x > 24) player.move(-SPEED, 0);
    });
    onKeyDown("d", ()=>{
        if (player.pos.x < width() - 24) player.move(SPEED, 0);
    });
    onKeyDown("w", ()=>{
        if (player.pos.y > 67) player.move(0, -SPEED);
    });
    onKeyDown("s", ()=>{
        if (player.pos.y < height() - 40) player.move(0, SPEED);
    });
}
//MAKE ENEMIES ------------------------------------------------------------------------------
function makeEne(amount, highPos) {
    for(let loops = 0; loops < amount; loops++)add([
...
function handleout() {
    return {
        ...
        update () {
            ...
            if (spos.x < 0 || spos.x > width() || spos.y < 0 || spos.y > height()) // triggers a custom event when out
            this.trigger("out");
        }
    };
}
...
parcelHelpers.export(exports, "default", ()=>ao);
var jt = Object.defineProperty, Ki = Object.defineProperties;
...
var Nt = (i, t, l)=>t in i ? jt(i, t, {
    ...
    return i;
}, D = (i, t)=>Ki(i, Hi(t)), a = (i, t)=>jt(i, "name", {
        value: t,
        configurable: !0
    });
var Qi = (i, t)=>{
...
a(xe, "Vec3");
var fe = a((i, t, l)=>new xe(i, t, l), "vec3"), le = class {
    constructor(t, l, w){
        b(this, "r", 255);
        b(this, "g", 255);
        b(this, "b", 255);
    ...
    static fromHSL(t, l, w) {
        ...
        let U = a((j, X, $)=>($ < 0 && ($ += 1), $ > 1 && ($ -= 1), $ < 1 / 6 ? j + (X - j) * 6 * $ : $ < 0.5 ? X : $ < 2 / 3 ? j + (X - j) * (2 / 3 - $) * 6 : j), "hue2rgb"), p = w < .5 ? w * (1 + l) : w + l - w * l, S = 2 * w - p, A = U(S, p, t + 1 / 3), q = U(S, p, t), k = U(S, p, t - 1 / 3);
...
a(E, "rgb");
var fr = a((i, t, l)=>v.fromHSL(i, t, l), "hsl2rgb"), V = class {
    constructor(t, l, w, U){
        b(this, "x", 0);
        b(this, "y", 0);
        b(this, "w", 1);
...
a(Ht, "wave");
var es = 1103515245, ts = 12345, hr = 2147483648, pe = class {
    constructor(t){
        b(this, "seed");
        this.seed = t;
    }
...
var qr = {
    ...
    "f11",
    "s"
], Dr = " !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~", fs = " ☺☻♥♦♣♠•◘○◙♂♀♪♫☼►◄↕‼\xb6\xa7▬↨↑↓→←∟↔▲▼ !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~⌂\xc7\xfc\xe9\xe2\xe4\xe0\xe5\xe7\xea\xeb\xe8\xef\xee\xec\xc4\xc5\xc9\xe6\xc6\xf4\xf6\xf2\xfb\xf9\xff\xd6\xdc\xa2\xa3\xa5₧ƒ\xe1\xed\xf3\xfa\xf1\xd1\xaa\xba\xbf⌐\xac\xbd\xbc\xa1\xab\xbb░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀α\xdfΓπΣσ\xb5τΦΘΩδ∞φε∩≡\xb1≥≤⌠⌡\xf7≈\xb0∙\xb7√ⁿ\xb2■", Ar = 0, Or = 3, ps = 0, ms = 3, ws = -1200, gs = 1200, je = "topleft", Ir = 1600, bt = 65536, Vr = 64, Us = "apl386o", on = "sink", Ye = 9, ys = `
...
var ao = a((i = {})=>{
    let t = (()=>{
        var s, o, d;
        let e1 = (s = i.root) != null ? s : document.body;
        e1 === document.body && (document.body.style.width = "100%", document.body.style.height = "100%", document.body.style.margin = "0px", document.documentElement.style.width = "100%", document.documentElement.style.height = "100%");
        let n = (o = i.canvas) != null ? o : (()=>{
            let h = document.createElement("canvas");
            return e1.appendChild(h), h;
        ...
        var d, h;
        let e1 = t.gl, n = hn(an, un), r = He(new ImageData(new Uint8ClampedArray([
            255,
            255,
            255,
            255
        ...
        if (i.background) {
            ...
            e1.clearColor(m.r / 255, m.g / 255, m.b / 255, (h = i.background[3]) != null ? h : 1);
        }
        e1.enable(e1.BLEND), e1.enable(e1.SCISSOR_TEST), e1.blendFuncSeparate(e1.SRC_ALPHA, e1.ONE_MINUS_SRC_ALPHA, e1.ONE, e1.ONE_MINUS_SRC_ALPHA);
        let c = e1.createBuffer();
        e1.bindBuffer(e1.ARRAY_BUFFER, c), e1.vertexAttribPointer(0, 3, e1.FLOAT, !1, Ye * 4, 0), e1.enableVertexAttribArray(0), e1.vertexAttribPointer(1, 2, e1.FLOAT, !1, Ye * 4, 12), e1.enableVertexAttribArray(1), e1.vertexAttribPointer(2, 4, e1.FLOAT, !1, Ye * 4, 20), e1.enableVertexAttribArray(2), e1.bufferData(e1.ARRAY_BUFFER, bt * 4, e1.DYNAMIC_DRAW), e1.bindBuffer(e1.ARRAY_BUFFER, null);
        let s = e1.createBuffer();
        e1.bindBuffer(e1.ELEMENT_ARRAY_BUFFER, s), e1.bufferData(e1.ELEMENT_ARRAY_BUFFER, bt * 2, e1.DYNAMIC_DRAW), e1.bindBuffer(e1.ELEMENT_ARRAY_BUFFER, null);
        let o = He(new ImageData(new Uint8ClampedArray([
            128,
            128,
            128,
            255,
        ...
        return {
            ...
            viewport: {
                x: 0,
                y: 0,
                width: e1.drawingBufferWidth,
                height: e1.drawingBufferHeight
            }
        };
    })();
    bn();
    let w = (()=>{
        let e1 = new (window.AudioContext || window.webkitAudioContext), n = e1.createGain();
        n.connect(e1.destination);
        let r = {
            buf: Fr()
        };
        return e1.decodeAudioData(sn.buffer.slice(0), (u)=>{
            r.buf = u;
        }, ()=>{
        ...
        gravity: Ir,
        on (e1, n) {
            return this.events[e1] || (this.events[e1] = new Y), this.events[e1].pushd(n);
        },
        trigger (e1, ...n) {
            this.events[e1] && this.events[e1].forEach((r)=>r(...n));
        },
        scenes: {},
        logs: [],
        cam: {
    ...
    a(A, "loadProgress");
    function q(e1) {
        return e1 !== void 0 && (U.urlPrefix = e1), U.urlPrefix;
    }
    a(q, "loadRoot");
    function k(e1) {
        let n = U.urlPrefix + e1;
    ...
    function j(e1) {
        let n = new Image;
        return n.src = cr(e1) ? e1 : U.urlPrefix + e1, n.crossOrigin = "anonymous", new Promise((r, u)=>{
            n.onload = ()=>r(n), n.onerror = ()=>u(`Failed to load image from "${e1}"`);
        });
    }
    a(j, "loadImg");
    function X(e1, n, r, u, c = {}) {
        return S(j(n).then((s)=>{
            var d;
            let o = Br(He(s, c), r, u, (d = c.chars) != null ? d : Dr);
            return e1 && (U.fonts[e1] = o), o;
        }));
    }
    a(X, "loadFont");
    function $(e1) {
        var n;
        return (n = U.sprites[e1]) != null ? n : null;
    }
    a($, "getSprite");
    function cn(e1) {
        var n;
        return (n = U.sounds[e1]) != null ? n : null;
    }
    a(cn, "getSound");
    function xt(e1) {
        var n;
        return (n = U.fonts[e1]) != null ? n : null;
    }
    a(xt, "getFont");
    function vt(e1) {
        var n;
        return (n = U.shaders[e1]) != null ? n : null;
    }
    a(vt, "getShader");
    function Se(e1 = 1, n = 1, r = 0, u = 0, c = 1, s = 1) {
        let o = [], d = c / e1, h = s / n;
        for(let m = 0; m < n; m++)for(let g = 0; g < e1; g++)o.push(new V(r + g * d, u + m * h, d, h));
        return o;
    }
    a(Se, "slice");
    function Ce(e1, n) {
        return S(typeof n == "string" ? k(n).then((r)=>r.json()).then((r)=>Ce(e1, r)) : J(null, e1).then((r)=>{
    ...
    function Re(e1, n, r = {}) {
        let u = He(n, r), c = Se(r.sliceX || 1, r.sliceY || 1), s = {
            tex: u,
            frames: c,
            anims: r.anims || {}
        };
        return e1 && (U.sprites[e1] = s), s;
    }
    a(Re, "loadRawSprite");
    function J(e1, n, r = {
        sliceX: 1,
        ...
        return S(new Promise((u, c)=>{
            if (!n) return c(`Expected sprite src for "${e1}"`);
            typeof n == "string" ? j(n).then((s)=>u(Re(e1, s, r))).catch(c) : u(Re(e1, n, r));
        }));
    }
    a(J, "loadSprite");
    function Xe(e1, n) {
    ...
    a(Gr, "loadBean");
    function _r(e1) {
        return e1 !== void 0 && (w.masterNode.gain.value = z(e1, Ar, Or)), w.masterNode.gain.value;
    }
    a(_r, "volume");
    function Ke(e1, n = {
        loop: !1,
        ...
        if (typeof e1 == "string") {
            ...
            return ye(()=>{
                let x = U.sounds[e1];
                if (!x) throw new Error(`Sound not found: "${e1}"`);
                let W = Ke(x, n);
                for(let O in W)y[O] = W[O];
            }), y;
        }
        let r = w.ctx, u = !1, c = r.createBufferSource();
        c.buffer = e1.buf, c.loop = !!n.loop;
        let s = r.createGain();
    ...
    a(Ke, "play");
    function ln(e1) {
        return Ke(w.burpSnd, e1);
    }
    a(ln, "burp");
    function He(e1, n = {}) {
        let r = t.gl, u = r.createTexture();
        r.bindTexture(r.TEXTURE_2D, u), r.texImage2D(r.TEXTURE_2D, 0, r.RGBA, r.RGBA, r.UNSIGNED_BYTE, e1);
        let c = (()=>{
            var o;
    ...
    a(He, "makeTex");
    function hn(e1 = an, n = un) {
        let r = t.gl, u, c = ys.replace("{{user}}", e1 != null ? e1 : an), s = bs.replace("{{user}}", n != null ? n : un), o = r.createShader(r.VERTEX_SHADER), d = r.createShader(r.FRAGMENT_SHADER);
...
`) throw new Error(u);
    ...
    a(hn, "makeShader");
    function Br(e1, n, r, u) {
        let c = e1.width / n, s = e1.height / r, o = 1 / c, d = 1 / s, h = {}, m = u.split("").entries();
    ...
    a(Br, "makeFont");
    function Tt(e1, n, r, u = l.defTex, c = l.defShader, s = {}) {
        u = u != null ? u : l.defTex, c = c != null ? c : l.defShader, (u !== l.curTex || c !== l.curShader || !Yt(l.curUniform, s) || l.vqueue.length + e1.length * Ye > bt || l.iqueue.length + n.length > bt) && dn();
        for (let o of e1){
        ...
        for (let o1 of n)l.iqueue.push(o1 + l.vqueue.length / Ye - e1.length);
    ...
    function dn() {
        ...
        let e1 = t.gl;
        l.curShader.send(l.curUniform), e1.bindBuffer(e1.ARRAY_BUFFER, l.vbuf), e1.bufferSubData(e1.ARRAY_BUFFER, 0, new Float32Array(l.vqueue)), e1.bindBuffer(e1.ELEMENT_ARRAY_BUFFER, l.ibuf), e1.bufferSubData(e1.ELEMENT_ARRAY_BUFFER, 0, new Uint16Array(l.iqueue)), l.curShader.bind(), l.curTex.bind(), e1.drawElements(e1.TRIANGLES, l.iqueue.length, e1.UNSIGNED_SHORT, 0), l.curTex.unbind(), l.curShader.unbind(), e1.bindBuffer(e1.ARRAY_BUFFER, null), e1.bindBuffer(e1.ELEMENT_ARRAY_BUFFER, null), l.iqueue = [], l.vqueue = [], l.drawCalls++;
    }
    a(dn, "flush");
    function ze() {
    ...
    a(Cs, "drawCalls");
    function Nr(e1) {
        return f(e1.x / F() * 2 - 1, -e1.y / G() * 2 + 1);
    }
    a(Nr, "screen2ndc");
    function Rs(e1) {
        return f((e1.x + 1) / 2 * F(), -(e1.y - 1) / 2 * G());
    }
    a(Rs, "ndc2screen");
    function Ws(e1) {
        l.transform = e1.clone();
    }
    a(Ws, "applyMatrix");
    function I(...e1) {
        if (e1[0] === void 0) return;
        let n = f(...e1);
    ...
    a(ne, "pushScale");
    function Ms(e1) {
        !e1 || (l.transform = l.transform.rotateX(e1));
    }
    a(Ms, "pushRotateX");
    function Ls(e1) {
        !e1 || (l.transform = l.transform.rotateY(e1));
    }
    a(Ls, "pushRotateY");
    function Qe(e1) {
        !e1 || (l.transform = l.transform.rotateZ(e1));
    }
    a(Qe, "pushRotateZ");
    function re() {
    ...
    function me(e1) {
        var h;
        if (e1.width === void 0 || e1.height === void 0) throw new Error('drawUVQuad() requires property "width" and "height".');
        if (e1.width <= 0 || e1.height <= 0) return;
        let n = e1.width, r = e1.height, c = $e(e1.origin || je).scale(f(n, r).scale(-0.5)), s = e1.quad || new V(0, 0, 1, 1), o = e1.color || E(255, 255, 255), d = (h = e1.opacity) != null ? h : 1;
        re(), I(e1.pos), Qe(e1.angle), ne(e1.scale), I(c), Tt([
            {
                pos: fe(-n / 2, r / 2, 0),
                uv: f(e1.flipX ? s.x + s.w : s.x, e1.flipY ? s.y : s.y + s.h),
                color: o,
                opacity: d
            },
            {
                pos: fe(-n / 2, -r / 2, 0),
                uv: f(e1.flipX ? s.x + s.w : s.x, e1.flipY ? s.y + s.h : s.y),
                color: o,
                opacity: d
            },
            {
                pos: fe(n / 2, -r / 2, 0),
                uv: f(e1.flipX ? s.x : s.x + s.w, e1.flipY ? s.y + s.h : s.y),
                color: o,
                opacity: d
            },
            {
                pos: fe(n / 2, r / 2, 0),
                uv: f(e1.flipX ? s.x : s.x + s.w, e1.flipY ? s.y : s.y + s.h),
                color: o,
                opacity: d
            }
        ], [
            ...
            2,
            3
        ], e1.fixed, e1.tex, e1.shader, e1.uniform), ie();
    }
    a(me, "drawUVQuad");
    function jr(e1) {
        var s;
        if (!e1.tex) throw new Error('drawTexture() requires property "tex".');
        let n = (s = e1.quad) != null ? s : new V(0, 0, 1, 1), r = e1.tex.width * n.w, u = e1.tex.height * n.h, c = f(1);
        if (e1.tiled) {
            let o = Math.ceil((e1.width || r) / r), d = Math.ceil((e1.height || u) / u), m = $e(e1.origin || je).add(f(1, 1)).scale(.5).scale(o * r, d * u);
            for(let g = 0; g < o; g++)for(let y = 0; y < d; y++)me(D(P({}, e1), {
                pos: (e1.pos || f(0)).add(f(r * g, u * y)).sub(m),
                scale: c.scale(e1.scale || f(1)),
                tex: e1.tex,
                quad: n,
                width: r,
                height: u,
        ...
        } else e1.width && e1.height ? (c.x = e1.width / r, c.y = e1.height / u) : e1.width ? (c.x = e1.width / r, c.y = c.x) : e1.height && (c.y = e1.height / u, c.x = c.y), me(D(P({}, e1), {
            scale: c.scale(e1.scale || f(1)),
            tex: e1.tex,
            quad: n,
            width: r,
    ...
    function fn(e1) {
        var u, c;
        if (!e1.sprite) throw new Error('drawSprite() requires property "sprite"');
        let n = yn(e1.sprite, U.sprites);
        if (!n) {
            if (typeof e1.sprite == "string") {
                St.has(e1.sprite) || (St.add(e1.sprite), J(e1.sprite, e1.sprite).then((s)=>St.delete(e1.sprite)));
                return;
            } else throw new Error(`sprite not found: "${e1.sprite}"`);
        }
        let r = n.frames[(u = e1.frame) != null ? u : 0];
        if (!r) throw new Error(`frame not found: ${(c = e1.frame) != null ? c : 0}`);
        jr(D(P({}, e1), {
            tex: n.tex,
            quad: r.scale(e1.quad || new V(0, 0, 1, 1)),
            uniform: e1.uniform
        }));
    }
    a(fn, "drawSprite");
    function Le(e1, n, r, u, c, s = 1) {
        u = de(u % 360), c = de(c % 360), c <= u && (c += Math.PI * 2);
        let o = Math.ceil(Math.max(Math.sqrt(n + r) * 3 * (s || 1), 16)), d = (c - u) / o, h = [];
        for(let m = u; m < c; m += d)h.push(e1.add(n * Math.cos(m), r * Math.sin(m)));
        return h.push(e1.add(n * Math.cos(c), r * Math.sin(c))), h;
    }
    a(Le, "getArcPts");
    function Q(e1) {
        if (e1.width === void 0 || e1.height === void 0) throw new Error('drawRect() requires property "width" and "height".');
        if (e1.width <= 0 || e1.height <= 0) return;
        let n = e1.width, r = e1.height, c = $e(e1.origin || je).add(1, 1).scale(f(n, r).scale(-0.5)), s = [
            f(0, 0),
            f(n, 0),
            f(n, r),
            f(0, r)
        ...
        if (e1.radius) {
            let o = Math.min(Math.min(n, r) / 2, e1.radius);
            s = [
                f(o, 0),
                f(n - o, 0),
    ...
    function qe(e1) {
        ...
        let u = e1.width || 1, c = r.sub(n).unit().normal().scale(u * .5), s = [
            n.sub(c),
            n.add(c),
            r.add(c),
            r.sub(c)
            ...
            return {
                pos: fe(o.x, o.y, 0),
                uv: f(0),
                color: (d = e1.color) != null ? d : v.WHITE,
                opacity: (h = e1.opacity) != null ? h : 1
            };
        });
        Tt(s, [
            0,
            ...
            2,
            3
        ], e1.fixed, l.defTex, e1.shader, e1.uniform);
    }
    a(qe, "drawLine");
    function pn(e1) {
        let n = e1.pts;
        ...
        if (!(n.length < 2)) {
            ...
            } else for(let r1 = 0; r1 < n.length - 1; r1++)qe(D(P({}, e1), {
                p1: n[r1],
                p2: n[r1 + 1]
            }));
        }
    ...
    a(pn, "drawLines");
    function mn(e1) {
        if (!e1.p1 || !e1.p2 || !e1.p3) throw new Error('drawPolygon() requires properties "p1", "p2" and "p3".');
        return Ze(D(P({}, e1), {
            pts: [
                e1.p1,
                e1.p2,
    ...
    a(mn, "drawTriangle");
    function Ct(e1) {
        if (!e1.radius) throw new Error('drawCircle() requires property "radius".');
        e1.radius !== 0 && wn(D(P({}, e1), {
            radiusX: e1.radius,
            radiusY: e1.radius,
            angle: 0
        }));
    ...
    function wn(e1) {
        var n, r;
        if (e1.radiusX === void 0 || e1.radiusY === void 0) throw new Error('drawEllipse() requires properties "radiusX" and "radiusY".');
        e1.radiusX === 0 || e1.radiusY === 0 || Ze(D(P({}, e1), {
            pts: Le(f(0), e1.radiusX, e1.radiusY, (n = e1.start) != null ? n : 0, (r = e1.end) != null ? r : 360, e1.resolution),
            radius: 0
        }));
    }
    a(wn, "drawEllipse");
    function Ze(e1) {
        var r, u;
        if (!e1.pts) throw new Error('drawPolygon() requires property "pts".');
        let n = e1.pts.length;
        if (!(n < 3)) {
            if (re(), I(e1.pos), ne(e1.scale), Qe(e1.angle), I(e1.offset), e1.fill !== !1) {
                let c = (r = e1.color) != null ? r : v.WHITE, s = e1.pts.map((d)=>{
                    var h;
                    return {
                        pos: fe(d.x, d.y, 0),
                        uv: f(0, 0),
                ...
                Tt(s, (u = e1.indices) != null ? u : o, e1.fixed, l.defTex, e1.shader, e1.uniform);
            }
            e1.outline && pn({
                pts: [
                    ...e1.pts,
                ...
                radius: e1.radius,
                width: e1.outline.width,
                color: e1.outline.color,
                uniform: e1.uniform,
                fixed: e1.fixed
            }), ie();
        }
    ...
    a(Ze, "drawPolygon");
    function gn(e1, n) {
        n.pos && (e1.pos = e1.pos.add(n.pos)), n.scale && (e1.scale = e1.scale.scale(f(n.scale))), n.angle && (e1.angle += n.angle), n.color && (e1.color = e1.color.mult(n.color)), n.opacity && (e1.opacity *= n.opacity);
    }
    a(gn, "applyCharTransform");
    let Un = new RegExp("\\[(?<text>[^\\]]*)\\]\\.(?<style>[\\w\\.]+)+", "g");
    function Yr(e1) {
        let n = {}, r = e1.replace(Un, "$1"), u = 0;
        for (let c of e1.matchAll(Un)){
    ...
    function yn(e1, n, r) {
        if (e1) return typeof e1 == "string" ? n[e1] : e1;
        if (r) return n[r];
    }
    a(yn, "findAsset");
    function we(e1) {
        var er, tr, nr;
        if (e1.text === void 0) throw new Error('formatText() requires property "text".');
        let n = yn((er = e1.font) != null ? er : i.font, U.fonts, Us);
        if (!n) throw new Error(`Font not found: ${e1.font}`);
        let { charStyleMap: r , text: u  } = Yr(e1.text + ""), c = u.split(""), s = n.qw * n.tex.width, o = n.qh * n.tex.height, d = e1.size || o, h = f(d / o).scale(f(e1.scale || 1)), m = h.x * s + ((tr = e1.letterSpacing) != null ? tr : 0), g = h.y * o + ((nr = e1.lineSpacing) != null ? nr : 0), y = 0, x = g, W = 0, O = [], M = [], ee = null, te = 0;
        for(; te < c.length;){
            let oe = c[te];
            oe === `
` ? (x += g, y = 0, ee = null, M.push(oe), O.push(M), M = []) : e1.width && y + m > e1.width && (x += g, y = 0, ee != null && (te -= M.length - ee, oe = c[te], M = M.slice(0, ee)), ee = null, O.push(M), M = []), oe !== `
` && (M.push(oe), y += m, oe === " " && (ee = M.length)), W = Math.max(W, y), te++;
        }
        O.push(M), e1.width && (W = e1.width);
        let Ve = [], ke = f(e1.pos || 0), _ = $e(e1.origin || je).scale(.5), se = -_.x * m - (_.x + .5) * (W - m), Fe = -_.y * g - (_.y + .5) * (x - g), ct = 0;
            ...
            oe.forEach((lt, Ni)=>{
                ...
                if (Gt) {
                    let _t = {
                        ...
                        opacity: e1.opacity,
                        color: (rr = e1.color) != null ? rr : E(255, 255, 255),
                        scale: h,
                        angle: 0,
                        uniform: e1.uniform,
                        fixed: e1.fixed
                    ...
                    if (e1.transform) {
                        let ht = typeof e1.transform == "function" ? e1.transform(ct, lt) : e1.transform;
                        ht && gn(_t, ht);
                    }
                    if (r[ct]) {
                        let { styles: ht1 , localIdx: $i  } = r[ct];
                        for (let Xi of ht1){
                            let Bt = e1.styles[Xi], ir = typeof Bt == "function" ? Bt($i, lt) : Bt;
                            ir && gn(_t, ir);
                        }
                    }
                    Ve.push(_t);
    ...
    function bn() {
        let e1 = t.gl, n = e1.drawingBufferWidth, r = e1.drawingBufferHeight, u = F(), c = G();
        if (Tn()) {
        ...
        if (i.letterbox) {
            ...
            let s1 = n / r, o1 = i.width / i.height;
            if (s1 > o1) {
                i.stretch || (l.width = r * o1, l.height = r);
                let d1 = r * o1, h1 = r, m2 = (n - d1) / 2;
                e1.scissor(m2, 0, d1, h1), e1.viewport(m2, 0, d1, r), l.viewport = {
                    x: m2,
                    y: 0,
                    width: d1,
                    height: r
                ...
                i.stretch || (l.width = n, l.height = n / o1);
                let d2 = n, h2 = n / o1, m3 = (r - h2) / 2;
                e1.scissor(0, m3, d2, h2), e1.viewport(0, m3, n, h2), l.viewport = {
                    x: 0,
                    y: m3,
                    width: n,
                    height: h2
        ...
        if (i.stretch) {
            ...
            e1.viewport(0, 0, n, r), l.viewport = {
                x: 0,
                y: 0,
                width: n,
                height: r
        ...
        l.width = n / t.scale, l.height = r / t.scale, e1.viewport(0, 0, n, r), l.viewport = {
            x: 0,
            y: 0,
            width: n,
            height: r
    ...
    a(G, "height"), t.canvas.addEventListener("mousemove", (e1)=>{
        t.mousePos = f((e1.offsetX - l.viewport.x) * F() / l.viewport.width, (e1.offsetY - l.viewport.y) * G() / l.viewport.height), t.mouseDeltaPos = f(e1.movementX, e1.movementY).scale(1 / t.scale), t.isMouseMoved = !0;
    }), t.canvas.addEventListener("mousedown", (e1)=>{
        let n = Pr[e1.button];
        n && (t.mouseStates[n] = "pressed");
    }), t.canvas.addEventListener("mouseup", (e1)=>{
        let n = Pr[e1.button];
        n && (t.mouseStates[n] = "released");
    }), t.canvas.addEventListener("keydown", (e1)=>{
        let n = qr[e1.key] || e1.key.toLowerCase();
        ds.includes(n) && e1.preventDefault(), n.length === 1 && t.charInputted.push(e1.key), n === "space" && t.charInputted.push(" "), e1.repeat ? (t.isKeyPressedRepeat = !0, t.keyStates[n] = "rpressed") : (t.isKeyPressed = !0, t.keyStates[n] = "pressed");
    }), t.canvas.addEventListener("keyup", (e1)=>{
        let n = qr[e1.key] || e1.key.toLowerCase();
        t.keyStates[n] = "released", t.isKeyReleased = !0;
    }), t.canvas.addEventListener("touchstart", (e1)=>{
        if (!i.touchToMouse) return;
        e1.preventDefault();
        let n = e1.touches[0];
        t.mousePos = f(n.clientX, n.clientY).scale(1 / t.scale), t.mouseStates.left = "pressed";
    }), t.canvas.addEventListener("touchmove", (e1)=>{
        if (!i.touchToMouse) return;
        e1.preventDefault();
        let n = e1.touches[0];
        t.mousePos = f(n.clientX, n.clientY).scale(1 / t.scale), t.isMouseMoved = !0;
    }), t.canvas.addEventListener("touchend", (e1)=>{
        !i.touchToMouse || (t.mouseStates.left = "released");
    }), t.canvas.addEventListener("touchcancel", (e1)=>{
        !i.touchToMouse || (t.mouseStates.left = "released");
    }), t.canvas.addEventListener("touchstart", (e1)=>{
        [
            ...e1.changedTouches
    ...
    }), t.canvas.addEventListener("contextmenu", function(e1) {
        e1.preventDefault();
    ...
    a(xn, "mouseDeltaPos");
    function Pe(e1 = "left") {
        return t.mouseStates[e1] === "pressed";
    }
    a(Pe, "isMousePressed");
    function et(e1 = "left") {
        return t.mouseStates[e1] === "pressed" || t.mouseStates[e1] === "down";
    }
    a(et, "isMouseDown");
    function tt(e1 = "left") {
        return t.mouseStates[e1] === "released";
    }
    ...
    a(Rt, "isMouseMoved");
    function De(e1) {
        return e1 === void 0 ? t.isKeyPressed : t.keyStates[e1] === "pressed";
    }
    a(De, "isKeyPressed");
    function Wt(e1) {
        return e1 === void 0 ? t.isKeyPressedRepeat : t.keyStates[e1] === "pressed" || t.keyStates[e1] === "rpressed";
    }
    a(Wt, "isKeyPressedRepeat");
    function Mt(e1) {
        return t.keyStates[e1] === "pressed" || t.keyStates[e1] === "rpressed" || t.keyStates[e1] === "down";
    }
    a(Mt, "isKeyDown");
    function nt(e1) {
        return e1 === void 0 ? t.isKeyReleased : t.keyStates[e1] === "released";
    }
    a(nt, "isKeyReleased");
    function Xr() {
        return [
    ...
    a(vn, "screenshot");
    function En(e1) {
        return e1 && (t.canvas.style.cursor = e1), t.canvas.style.cursor;
    }
    a(En, "cursor");
    function Kr(e1 = !0) {
        e1 ? Es(t.canvas) : Ts();
    ...
    let C = {
        ...
        clearLog: ()=>p.logs = [],
        log: (e1)=>p.logs.unshift(`[${rt().toFixed(2)}].time [${e1}].info`),
        error: (e1)=>p.logs.unshift(`[${rt().toFixed(2)}].time [${e1}].error`),
        curRecording: null,
        get paused () {
            return t.paused;
        },
    ...
    a(Jr, "layers");
    function Qr(...e1) {
        return e1.length > 0 && (p.cam.pos = f(...e1)), p.cam.pos.clone();
    }
    a(Qr, "camPos");
    function Zr(...e1) {
        return e1.length > 0 && (p.cam.scale = f(...e1)), p.cam.scale.clone();
    }
    a(Zr, "camScale");
    function ei(e1) {
        return e1 !== void 0 && (p.cam.angle = e1), p.cam.angle;
    }
    a(ei, "camRot");
    function ti(e1 = 12) {
        p.cam.shake = e1;
    ...
    a(ti, "shake");
    function it(e1) {
        return p.cam.transform.multVec2(e1);
    }
    a(it, "toScreen");
    function Lt(e1) {
        return p.cam.transform.invert().multVec2(e1);
    }
    a(Lt, "toWorld");
    function Sn(e1) {
        let n = new Map, r = {}, u = {}, c = {
        ...
        for (let s of e1)c.use(s);
        return c;
    }
    a(Sn, "make");
    function Ae(e1, n, r) {
        return p.objEvents[e1] || (p.objEvents[e1] = new Y), p.objEvents[e1].pushd({
            tag: n,
            cb: r
        });
    }
    a(Ae, "on");
    function Oe(e1, n) {
        if (typeof e1 == "function" && n === void 0) return p.root.onUpdate(e1);
        if (typeof e1 == "string") return Ae("update", e1, n);
    }
    a(Oe, "onUpdate");
    function Cn(e1, n) {
        if (typeof e1 == "function" && n === void 0) return p.root.onDraw(e1);
        if (typeof e1 == "string") return Ae("draw", e1, n);
    }
    a(Cn, "onDraw");
    function Rn(e1, n, r) {
        let u = Ae("collide", e1, (o, d, h)=>d.is(n) && r(o, d, h)), c = Ae("collide", n, (o, d, h)=>d.is(e1) && r(d, o, h)), s = Oe(e1, (o)=>{
    ...
    a(Rn, "onCollide");
    function Wn(e1, n) {
        return typeof e1 == "function" ? At(e1) : Oe(e1, (r)=>{
    ...
    function qt(e1, n) {
        if (Array.isArray(e1)) {
            let r = e1.map((u)=>qt(u, n));
            return ()=>r.forEach((u)=>u());
        }
        return p.on("input", ()=>Mt(e1) && n());
    }
    a(qt, "onKeyDown");
    function H(e1, n) {
        if (Array.isArray(e1)) {
            let r = e1.map((u)=>H(u, n));
            return ()=>r.forEach((u)=>u());
        } else return typeof e1 == "function" ? p.on("input", ()=>De() && e1()) : p.on("input", ()=>De(e1) && n());
    }
    a(H, "onKeyPress");
    function Pt(e1, n) {
        if (Array.isArray(e1)) {
            let r = e1.map((u)=>Pt(u, n));
            return ()=>r.forEach((u)=>u());
        } else return typeof e1 == "function" ? p.on("input", ()=>De() && e1()) : p.on("input", ()=>Wt(e1) && n());
    }
    a(Pt, "onKeyPressRepeat");
    function Dt(e1, n) {
        if (Array.isArray(e1)) {
            let r = e1.map((u)=>Dt(u, n));
            return ()=>r.forEach((u)=>u());
        } else return typeof e1 == "function" ? p.on("input", ()=>nt() && e1()) : p.on("input", ()=>nt(e1) && n());
    }
    a(Dt, "onKeyRelease");
    function qn(e1, n) {
        return typeof e1 == "function" ? p.on("input", ()=>et() && e1(K())) : p.on("input", ()=>et(e1) && n(K()));
    }
    a(qn, "onMouseDown");
    function At(e1, n) {
        return typeof e1 == "function" ? p.on("input", ()=>Pe() && e1(K())) : p.on("input", ()=>Pe(e1) && n(K()));
    }
    a(At, "onMousePress");
    function Pn(e1, n) {
        return typeof e1 == "function" ? p.on("input", ()=>tt() && e1(K())) : p.on("input", ()=>tt(e1) && n(K()));
    }
    a(Pn, "onMouseRelease");
    function Dn(e1) {
        return p.on("input", ()=>Rt() && e1(K(), xn()));
    }
    a(Dn, "onMouseMove");
    function An(e1) {
        return p.on("input", ()=>Xr().forEach((n)=>e1(n)));
    }
    a(An, "onCharInput");
    function On(e1) {
        return p.on("onTouchStart", e1);
    }
    a(On, "onTouchStart");
    function In(e1) {
        return p.on("onTouchMove", e1);
    }
    a(In, "onTouchMove");
    function Vn(e1) {
        return p.on("onTouchEnd", e1);
    }
    a(Vn, "onTouchEnd");
    function kn() {
        H("f1", ()=>{
    ...
    a(Fn, "enterBurpMode");
    function Gn(e1) {
        return e1 !== void 0 && (p.gravity = e1), p.gravity;
    }
    a(Gn, "gravity");
    function ri(e1, n) {}
    a(ri, "regCursor");
                ...
                if (this.solid && ((o = this.area) == null ? void 0 : o.shape) === "rect") {
                    ...
                    p.root.every((h)=>{
                        ...
                        let y = {
                            p1: f(0),
                            p2: f(u, c)
                        }, x = 1, W = g.p1, O = f(g.p1.x, g.p2.y), M = g.p2, ee = f(g.p2.x, g.p1.y), te = 0, Ve = {
                            right: {
                                p1: W,
                                p2: O
                            },
                        ...
                        for(let _1 in Ve){
                            let se1 = Ve[_1];
                            if (u === 0 && se1.p1.x === 0 && se1.p2.x === 0 || c === 0 && se1.p1.y === 0 && se1.p2.y === 0) {
                                x = 1;
                                break;
                            }
                            let Fe = Qt(y, se1);
    ...
    a(si, "color");
    function Ue(e1, n) {
        return Number(e1.toFixed(n));
    }
    a(Ue, "toFixed");
    function oi(e1) {
        return {
            id: "opacity",
            opacity: e1 != null ? e1 : 1,
            inspect () {
    ...
    a(oi, "opacity");
    function Ot(e1) {
        if (!e1) throw new Error("please define an origin");
        return {
            id: "origin",
            origin: e1,
            inspect () {
    ...
    function ci(e1, n) {
        return {
            ...
            add () {
                e1.exists() && (this.pos = this.follow.obj.pos.add(this.follow.offset));
            },
            update () {
                e1.exists() && (this.pos = this.follow.obj.pos.add(this.follow.offset));
            }
    ...
    a(ci, "follow");
    function li(e1, n) {
        let r = typeof e1 == "number" ? L.fromAngle(e1) : e1.unit();
        return {
            id: "move",
            require: [
                "pos"
    ...
    function It(e1 = {}) {
        ...
        return {
            ...
            isOutOfView () {
                var s;
                let u = f((s = e1.offset) != null ? s : 0), c = new ve(f(0, 0).sub(u), f(F(), G()).add(u));
            ...
            update () {
                if (this.isOutOfView()) {
                    if (r || (this.trigger("exitView"), r = !0), e1.delay && (n += Z(), n < e1.delay)) return;
                    e1.hide && (this.hidden = !0), e1.pause && (this.paused = !0), e1.destroy && this.destroy();
                } else r && (this.trigger("enterView"), r = !1), n = 0, e1.hide && (this.hidden = !1), e1.pause && (this.paused = !1);
            },
            inspect () {
    ...
    a(It, "outview");
    function hi(e1 = {}) {
        return typeof e1 == "number" ? (B("clean(time)", "cleanup({ delay: time })"), D(P({}, It({
            destroy: !0,
            delay: e1
        })), {
            id: "cleanup"
    ...
    function di(e1 = {}) {
        ...
        return {
            ...
            area: {
                shape: "rect",
                offset: (r = e1.offset) != null ? r : f(0),
                width: e1.width,
                height: e1.height,
                scale: (u = e1.scale) != null ? u : f(1),
                cursor: e1.cursor
            },
            isClicked () {
            ...
            worldArea () {
                ...
                c *= o.x, s *= o.y;
                let d = $e(this.origin || je), h = ((x = this.pos) != null ? x : f(0)).add(this.area.offset).sub(d.add(1, 1).scale(.5).scale(c, s));
                return {
                    shape: "rect",
                    p1: h,
                    p2: f(h.x + c, h.y + s)
    ...
    function Vt(e1, n = {}) {
        ...
        return a(c, "calcTexScale"), {
            ...
            load () {
                if (typeof e1 == "string" ? r = U.sprites[e1] : r = e1, !r) throw new Error(`sprite not found: "${e1}"`);
            ...
            inspect () {
                let o = "";
                return typeof e1 == "string" ? o += JSON.stringify(e1) : o += "[blob]", o;
            }
        };
    }
    a(Vt, "sprite");
    ...
    function Bn(e1, n) {
        let r = new Y;
        return e1 && n && r.pushd(new ce(e1, n)), {
            id: "timer",
            wait (u, c) {
    ...
    function bi(e1 = {}) {
        ...
        return {
            ...
            jumpForce: (s = e1.jumpForce) != null ? s : Ui,
            weight: (o = e1.weight) != null ? o : 1,
            solid: (d = e1.solid) != null ? d : !0,
            update () {
                var m;
                let h = !1;
                if (r) {
                ...
                if (!r) {
                    let g1 = this.move(0, n);
                    if (g1) {
                        if (g1.isBottom()) {
                            r = g1.target;
                            let y1 = n;
                            n = 0, r.pos && (u = r.pos.clone()), h || (this.trigger("ground", r), c = !0);
                        } else g1.isTop() && (n = 0, this.trigger("headbutt", g1.target));
                    }
                    n += Gn() * this.weight * Z(), n = Math.min(n, (m = e1.maxVel) != null ? m : yi);
                }
            },
            curPlatform () {
                return r;
    ...
    a(kt, "stay");
    function Ti(e1) {
        if (e1 == null) throw new Error("health() requires the initial amount of hp");
        return {
            id: "health",
            hurt (n = 1) {
                this.setHP(e1 - n), this.trigger("hurt");
            },
            heal (n = 1) {
                this.setHP(e1 + n), this.trigger("heal");
            },
            hp () {
                return e1;
            },
            setHP (n) {
                e1 = n, e1 <= 0 && this.trigger("death");
            },
            onHurt (n) {
    ...
    function Si(e1, n = {}) {
        var s;
        if (e1 == null) throw new Error("lifespan() requires time");
        let r = 0, u = (s = n.fade) != null ? s : 0, c = Math.max(e1 - u, 0);
        return {
            id: "lifespan",
            update () {
                r += Z(), r >= c && (this.opacity = dt(r, c, e1, 1, 0)), r >= e1 && this.destroy();
            }
        };
    }
    a(Si, "lifespan");
    function Ci(e1, n, r) {
        if (!e1) throw new Error("state() requires an initial state");
        let u = {};
        function c(d) {
            u[d] || (u[d] = {
                enter: [],
    ...
    a(Ri, "scene");
    function Wi(e1, ...n) {
        if (!p.scenes[e1]) throw new Error(`scene not found: ${e1}`);
        let r = p.on("updateStart", ()=>{
            p.events = {}, p.objEvents = {
                ...
                shake: 0,
                transform: new R
            }, p.layers = {}, p.defLayer = null, p.gravity = Ir, p.scenes[e1](...n), i.debug !== !1 && kn(), i.burp && Fn(), r();
        });
    }
    a(Wi, "go");
    function Mi(e1, n) {
        try {
            return JSON.parse(window.localStorage[e1]);
        } catch (r) {
            return n ? (Nn(e1, n), n) : null;
        }
    }
    a(Mi, "getData");
    function Nn(e1, n) {
        window.localStorage[e1] = JSON.stringify(n);
    }
    a(Nn, "setData");
    function jn(e1) {
        let n = e1(be);
    ...
    function Li(e1, n) {
        return {
            ...
            setGridPos (...r) {
                let u = f(...r);
                this.gridPos = u.clone(), this.pos = f(e1.offset().x + this.gridPos.x * e1.gridWidth(), e1.offset().y + this.gridPos.y * e1.gridHeight());
            },
            moveLeft () {
    ...
    function qi(e1, n) {
        ...
        let r = [], u = f(n.pos || f(0)), c = 0, s = {
            ...
            height () {
                return e1.length * n.height;
            },
            destroy () {
                for (let o of r)o.destroy();
            }
        };
        return e1.forEach((o, d)=>{
            let h = o.split("");
    ...
    a(qi, "addLevel");
    function Yn(e1) {
        let n = t.canvas.captureStream(e1), r = w.ctx.createMediaStreamDestination();
    ...
    a($n, "isFocused");
    function Ft(e1) {
        return p.root.add(e1);
    }
    a(Ft, "add");
    function Di(e1) {
        return p.root.readd(e1);
    }
    a(Di, "readd");
    function ut(e1) {
        return p.root.remove(e1);
    }
    a(ut, "destroy");
    function Ai(e1) {
        return p.root.removeAll(e1);
    }
    a(Ai, "destroyAll");
    function Oi(...e1) {
        return p.root.get(...e1);
    }
    a(Oi, "get");
    function Ii(...e1) {
        return p.root.every(...e1);
    }
    a(Ii, "every");
    function Vi(...e1) {
        return p.root.revery(...e1);
    }
    a(Vi, "revery");
    function Xn(e1 = 2, n = 1) {
        let r = 0;
        return {
            id: "explode",
            require: [
    ...
    a(Xn, "explode");
    let Kn = null, Hn = null;
    J(null, Mr).then((e1)=>Kn = e1), J(null, Lr).then((e1)=>Hn = e1);
    function ki(e1, n = {}) {
        var o, d;
        let r = (n.speed || 1) * 5, u = n.scale || 1, c = Ft([
            st(e1),
            Vt(Hn),
            ot(0),
            kt(),
    ...
    a(qs, "frames");
    function zn() {
        p.trigger("updateStart"), p.timers.forEach((e1, n)=>{
            e1.time -= Z(), e1.time <= 0 && (e1.action(), p.timers.delete(n));
        }), p.root.update();
    }
    a(zn, "updateFrame");
    function Fi() {
        let e1 = p.cam, n = L.fromAngle(Be(0, 360)).scale(e1.shake);
        e1.shake = _e(e1.shake, 0, 5 * Z()), e1.transform = new R().translate(at()).scale(e1.scale).rotateZ(e1.angle).translate(e1.pos.scale(-1).add(n)), p.root.draw();
    }
    a(Fi, "drawFrame");
    function Gi() {
        let e1 = A();
        if (e1 === 1) t.loaded = !0, p.trigger("load");
        else {
    ...
    function Jn(e1, n) {
        ...
        e1.x + c / t.scale >= F() && I(f(-c, 0)), e1.y + s / t.scale >= G() && I(f(0, -s)), Q({
            width: c,
            height: s,
            color: E(0, 0, 0),
            radius: 4,
    ...
    function Qn() {
        var e1, n;
        if (C.inspect) {
            let r = null, u = v.fromArray((e1 = i.inspectColor) != null ? e1 : [
                0,
                0,
                255
            ]);
...
`));
        ...
        if (C.timeScale !== 1) {
            ...
            Q({
                width: u2.width + r2 * 2 + r2 * 4,
                height: u2.height + r2 * 2,
                origin: "botright",
                color: E(0, 0, 0),
                opacity: .8,
                radius: 4,
            ...
            for(let c1 = 0; c1 < 2; c1++){
                let s1 = C.timeScale < 1;
                mn({
                    p1: f(-u2.width - r2 * (s1 ? 2 : 3.5), -r2),
                    p2: f(-u2.width - r2 * (s1 ? 2 : 3.5), -r2 - u2.height),
                    p3: f(-u2.width - r2 * (s1 ? 3.5 : 2), -r2 - u2.height / 2),
                    pos: f(-c1 * r2 * 1 + (s1 ? -r2 * .5 : 0), 0),
                    color: E(255, 255, 255),
                    fixed: !0
                });
            }
        ...
        if (C.curRecording && (re(), I(0, G()), ne(1 / t.scale), I(24, -24), Ct({
            ...
            let r3 = 8, u3 = (n = i.logMax) != null ? n : 1;
            p.logs.length > u3 && (p.logs = p.logs.slice(0, u3));
            let c2 = we({
                text: p.logs.join(`
`),
                font: U.fonts[on],
    ...
    a(Qn, "drawDebug"), i.debug !== !1 && kn(), i.burp && Fn(), window.addEventListener("error", (e1)=>{
        C.error(`Error: ${e1.error.message}`), Hr(), Zn(()=>{
            A() === 1 && (ze(), Qn(), Je());
        });
    });
    function Zn(e1) {
        let n = a((r)=>{
            ...
            t.realTime = u, t.skipTime || (t.dt = c, t.time += t.dt, t.fpsCounter.tick(t.dt)), t.skipTime = !1, t.numFrames++, e1();
            for(let s in t.keyStates)t.keyStates[s] = kr(t.keyStates[s]);
            for(let s1 in t.mouseStates)t.mouseStates[s1] = kr(t.mouseStates[s1]);
    ...
    if (i.plugins && i.plugins.forEach(jn), i.global !== !1) for(let e1 in be)window[e1] = be[e1];
    return be;
}, "default");
...
},{}]},["dhiId","9epqw"], "9epqw", "parcelRequire94c2")

//# sourceMappingURL=index.dd548bb5.js.map
